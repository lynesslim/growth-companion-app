...
# Add import
content = content.replace("import '../../providers/user_provider.dart';", "import '../../providers/user_provider.dart';\nimport '../../providers/journal_provider.dart';")

# Add _showSendDialog and _showJournalPicker
methods_code = """
...
content = content.replace("  @override\n  Widget build(BuildContext context) {", methods_code)

# Replace the onSendDrop mapping in _FriendsBody instantiation
content = content.replace("onShareInvite: () => _shareInvite(userId),", "onShareInvite: () => _shareInvite(userId),\n            onSendDrop: _showSendDialog,")
