...
* Ensure all newline characters are escaped correctly for JSON compatibility.' WHERE id IN ('social_growth_drop', 'daily_growth_drop');

DELETE FROM growth_drops WHERE drop_date = current_date;
